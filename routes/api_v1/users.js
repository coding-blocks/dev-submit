...
router.get('/:id',utils.acl.ensureUserLogin,utils.acl.ensureOwnUser(req.params.id), function (req, res) {
    db.actions.users.getUser(req.params.id, (data) => {
        res.send(data)
    })
})
router.put('/:id',utils.acl.ensureUserLogin,utils.acl.ensureOwnUser(req.params.id), function (req, res) {
...
router.delete('/:id',utils.acl.ensureUserLogin,utils.acl.ensureOwnUser(req.params.id), function (req, res) {
